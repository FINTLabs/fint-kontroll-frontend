...
export const applicationCategoriesHandlers = [
    http.get(
        'http://localhost:8063/beta/fintlabs-no/api/resources/kodeverk/applikasjonskategori/v1',
        () => {
    ...
    http.get(
        'http://localhost:8063/beta/fintlabs-no/api/resources/kodeverk/handhevingstype/v1',
        () => {
            return HttpResponse.json([
                {
                    id: 1,
