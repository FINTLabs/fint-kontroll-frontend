...
import { createDeviceAssignment } from '~/data/fetch-assignments';
import { fetchResourceById } from '~/data/fetch-resources';
import React, { useState } from 'react';
import { getResourceNewDeviceGroupAssignmentUrl } from '~/data/paths';
    ...
    return (
        <>
            <Modal
                ...
                onClose={() =>
                    navigate(
                        `${getResourceNewDeviceGroupAssignmentUrl(Number(params.id))}${prepareQueryParamsWithResponseCode(searchParams)}`
                    )
                }
                header={{
            ...
            >
                ...
                <Modal.Footer>
                    <Form method={'POST'}>
                        ...
                        <input value={params.devicegroupId} type="hidden" name="deviceGroupRef" />
                    ...
                    <Button
                        ...
                        onClick={() =>
                            navigate(
                                `${getResourceNewDeviceGroupAssignmentUrl(Number(params.id))}${prepareQueryParams(searchParams)}`
                            )
                        }
                    >
                        Avbryt
