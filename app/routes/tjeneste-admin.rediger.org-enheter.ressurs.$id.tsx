    ...
    breadcrumb: ({ params }) => (
        <HStack align={'start'}>
            <HStack justify={'center'} align={'center'}>
                <Link to={`/resource-admin`} className={'breadcrumb-link'}>
...
const CheckedValidForOrgUnits = (
    orgUnitTree: IUnitTree,
    ...
    const newList = orgUnitTree.orgUnits.map((orgUnit) => {
        const matchedUnit = resource.validForOrgUnits.find(
            (unit) => unit.orgUnitId === orgUnit.organisationUnitId
        );
                ...
                <HStack gap="4" justify={'end'}>
                    ...
                    <Form method="PUT">
                        ...
                        <input
                            ...
                            name="platform"
                            id="platform"
                            value={newResource.platform.join(',')}
                        />
                        <input
                            type="hidden"
                            name="accessType"
                        ...
                        <input
                            type="hidden"
                            name="resourceOwnerOrgUnitId"
                            id="resourceOwnerOrgUnitId"
                            value={selectedOwnerOrgUnit?.organisationUnitId}
                        />
                        <input
                            type="hidden"
                            name="resourceOwnerOrgUnitName"
                            id="resourceOwnerOrgUnitName"
                        ...
                        <input
                            ...
                            value={JSON.stringify(
                                selectedValidForOrgUnits.map(mapOrgUnitListToValidForOrgUnits)
                            )}
                        />
                        <input
                            type="hidden"
                        ...
                        <input
                            ...
                            name="hasCost"
                            id="hasCost"
                            value={newResource.hasCost.toString()}
                        />
                        <input
                            type="hidden"
