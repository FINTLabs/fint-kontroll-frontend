...
import { getResourceDeviceGroupAssignmentsUrl } from '~/data/paths';
    ...
    return (
        <>
            <Modal
                ...
                onClose={() =>
                    navigate(
                        `${getResourceDeviceGroupAssignmentsUrl(Number(params.id))}?page=${searchParams.get('page')}&search=${searchParams.get('search')}`
                    )
                }
                header={{
