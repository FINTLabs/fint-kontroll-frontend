...
export default function ResourceModuleAdminTabTildel() {
    ...
    const [newAssignment, setNewAssignment] = useState<IAssignment | null>({user: null,accessRoleId:"", scopeId: 0, orgUnits:[]})
    return (
        <section>
            <Tabs value={"tildel"}>
                ...
                <Tabs.Panel value="tildel" className="h-24 w-full bg-gray-50 p-4">
                    <AssignRightsUserTable newAssignment={newAssignment} setNewAssignment={setNewAssignment} usersPage={users} />
