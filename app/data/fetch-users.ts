export const fetchUsers = async (token: string | null, size: string, page: string, search: string) => {
    const response = await fetch(`http://localhost:8062/beta/fintlabs-no/api/users?size=${size}&page=${page}&search=${search}`, {
